 ...
 * project path assumed by symmetry, not independently verified). Every
 * other agent falls back to the generic .agents convention's AGENTS.md
 * rather than a guessed filename — see SPEC.md Open Question #8.
 */
